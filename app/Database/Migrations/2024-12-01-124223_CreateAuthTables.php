...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'profile_picture'  => ['type' => 'varchar', 'constraint' => 255, 'default' => 'assets/profile.png'],
        ...
        $this->forge->addField([
            ...
            'user_id'    => ['type' => 'bigint', 'constraint' => 11, 'unsigned' => true, 'null' => true], // Only for successful logins
            'date'       => ['type' => 'datetime'],
        ...
        $this->forge->addField([
            ...
            'user_id'         => ['type' => 'bigint', 'constraint' => 11, 'unsigned' => true],
        ...
        $fields = [
            'group_id'      => ['type' => 'bigint', 'constraint' => 11, 'unsigned' => true, 'default' => 0],
            'permission_id' => ['type' => 'bigint', 'constraint' => 11, 'unsigned' => true, 'default' => 0],
        ];
        ...
        $fields = [
            'group_id' => ['type' => 'bigint', 'constraint' => 11, 'unsigned' => true, 'default' => 0],
            'user_id'  => ['type' => 'bigint', 'constraint' => 11, 'unsigned' => true, 'default' => 0],
        ];
